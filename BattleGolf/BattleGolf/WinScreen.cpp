...
int WinScreen::init()
{
	background = new Background(this->ws_renderer, screenWidth, screenHeight);
	//title card
...
{
	background->draw();
	int black[4] = { 0,0,0,255 }; //specified green for the font
	std::string score = "Par: " + std::to_string(ws_score);
